...
if __name__ == "__main__":
    ...
    args = [
        '--log-to', 'runs/experiments/pendulum-1/2_3_ActualPendulumEnergy_5_6_7',
        '--batch-size', '2000',
        '--learning-rate', '0.005',
        '--epochs', '1000',
        '--test-with', 'pendulum[n=2,test]', 'pendulum[n=2]',
        'stabledynamics[latent_space_dim=4,a=3,projfn=ActualPendulumEnergy,pendulum_n=2,smooth_v=6,hp=60,h=100,rehu=7]',
        'experiments/pendulum-1/2_3_ActualPendulumEnergy_5_6_7/checkpoint_{epoch:0>5}.pth'
    ]
